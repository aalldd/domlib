...
// 获取元素的数组
var div1 = dom.find('#test_find')[0]; // 获取目标元素的第一个

var div2 = dom.findOne('#test_find'); // 获取某个div下面的元素

var div3 = dom.find('#test_find', div1)[0]; // 获取多个div.red元素

var divList = dom.find('.red');
console.log(div1);
console.log(div2);
console.log(div3);
console.log(divList); // 测试style

var div4 = dom.findOne('#test_style');
